...
> labels — no displacement). The live channel for new work is
> `docs/collaboration/active_task.md`.
>
> **Reading the round citations elsewhere in the repo:** other files cite this
> record as "round N". Those citations now name this archived file. **Within
> this log**, references to `docs/collaboration/active_task.md` mean *this
> file* as it stood while it was the active log — the round text is a
> historical record and has deliberately not been rewritten to say otherwise.

This file was the shared handoff and review channel for the task below. Codex
was the implementer and Claude the independent reviewer.
