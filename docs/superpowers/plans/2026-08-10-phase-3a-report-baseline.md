...
def test_code_dataset_publisher_stages_vendor_directory() -> None:
    script = Path("scripts/publish_code_dataset.sh").read_text()
    assert 'cp -R "${REPO_ROOT}/vendor" "${STAGE_DIR}/vendor"' in script
```
