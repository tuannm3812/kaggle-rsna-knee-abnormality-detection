...
_LABEL_PATTERNS: dict[str, list[str]] = {
    ...
    "Medial OA": [r"\bmedial\b.{0,20}(osteoarthritis|compartment.{0,10}\boa\b)"],
    "Lateral OA": [r"\blateral\b.{0,20}(osteoarthritis|compartment.{0,10}\boa\b)"],
    "PF OA": [r"\bpatellofemoral\b.{0,20}(osteoarthritis|\boa\b)", r"\bpf oa\b"],
    "Effusion": [r"effusion"],
